...
@alfareza(outgoing=True, pattern="^.sayang$")
async def koc(e):
...
@alfareza(outgoing=True, pattern='^.dino(?: |$)(.*)')
...
@alfareza(outgoing=True, pattern="^.gabut$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@alfareza(outgoing=True, pattern='^.terkadang(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
...
@alfareza(outgoing=True, pattern="^.mf$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`mf g dl` **ミ(ノ;_ _)ノ=3** ")


@alphabot.on(events.NewMessage(pattern=r"\.(.*)", outgoing=True))
async def _(event):
...
@alfareza(outgoing=True, pattern='^.gombal(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.mantan(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.sedih(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.salam(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.jawab(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern="^.pantun$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        sleep(1)
        await e.edit("I LOVEE YOUUU 💕")
...
@alfareza(outgoing=True, pattern='^.galau(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(5)
...
@alfareza(outgoing=True, pattern='^.sad(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.razia(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("` 🏍️ `")
...
@alfareza(outgoing=True, pattern='^.wkwk(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("` 😂 `")
...
@alfareza(outgoing=True, pattern='^.melamar(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.buaya(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.yang(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
@alfareza(outgoing=True, pattern='^.raziamasker(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
...
@alfareza(outgoing=True, pattern="^.ngabuburit$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@alfareza(outgoing=True, pattern='^.voff(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(".                       /¯ )")
    await typew.edit(".                       /¯ )\n                      /¯  /")
...
CmdHelp ('alphakata').add_command( 'voff', None, 'Tampilan Fuck you.' 
    ...
    ).add_command( 'mantan', None, 'Teringat mantan.'
    ).add_command( 'gabut', None, 'gabut beneran dah hiks.' 
    ).add_command( 'sayang', None, 'Hai sayang ku .' 
    ).add_command( 'razia', None, 'Ada razia lariii. ' 
    ).add_command( 'terkadang', None, 'Terkadang hidup memilukan.' 
    ).add_command( 'cinta', None, 'Mengirim cintaku. ' 
    ).add_command( 'buaya', None, 'Melihat inisial buaya.' 
    ).add_command( 'melamar', None, 'Kata kata dilan.' 
    ).add_command( 'sedih', None, 'Menyedihkan.' 
    ).add_command( 'wkwk', None, 'ketawa ga jelas.' 
    ).add_command( 'sad', None, 'sedih gajelas.' 
    ).add_command( 'galau', None, 'galau kali.' 
    ).add_command( 'dino', None, 'dikerjar dino.' 
    ).add_command( 'gombal', None, 'gombal anak orang.' 
    ).add_command( 'pantun', None, 'Pantun gajelas.' 
    ).add_command( 'jawab', None, 'Jawab salam.' 
    ).add_command( 'salam', None, 'mengucapkan salam.' 
    ).add()
